...
if __name__ == "__main__":
    ...
    goals = [
        np.array([-0.055, -0.020, 0.12]),  # Goal for index fingertip
        np.array([-0.055, -0.065, 0.12])  # Goal for thumb fingertip
    ]
    site_names = ["tip2", "tip3"]  # Sites for index finger and thumb
